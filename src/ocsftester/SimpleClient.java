...
/**
 * The <code> SimpleClient </code> class is a simple subclass of the
 * <code> ocsf.server.AbstractClient </code> class. It allows testing of the
 * functionalities offered by the OCSF framework. The
 * <code> java.awt.List </code> instance is used to display informative
 * messages. This list is pink when the connection has been closed, red when an
 * exception is received, and green when connected to the server.
 * 
