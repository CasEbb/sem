...
public abstract class AbstractClient implements Runnable {
	...
	/**
	 * Hook method called after the connection with the server has been closed
	 * by this client. The default implementation does nothing. The method may
	 * be overriden by subclasses to perform special processing such as cleaning
	 * up and terminating, or attempting to reconnect.
	 */
