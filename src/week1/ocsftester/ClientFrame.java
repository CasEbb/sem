...
/**
 * The <code> ClientFrame </code> class is a simple interactive application made
 * to exercise the OCSF framework.
 * <p>
 * Type <code>java ocsftester.ClientFrame host port_number</code> to start one
 * client.
 * <p>
 * The window is pink when the connection has been closed, red when an exception
 * is received, and green when connected to the server.
 * 
...
public class ClientFrame extends Frame {
	...
	/**
	 * Starts the client. The default host is localhost. The default port is
	 * 12345.
	 */
