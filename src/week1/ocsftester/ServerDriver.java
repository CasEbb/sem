...
/**
 * The <code> ServerDriver </code> class is a driver of the
 * <code> ServerFrame </code> class. It automatically changes the states of the
 * server a follows: listen for 10 sec, stop for 5 sec, close for 5 sec, listen
 * for 20 sec, stop for 10 sec, listen for 10 sec, stop for 5 sec. This cycle is
 * indefinitely repeated.
 * <p>
 * Type <code>java ocsftester.ServerDriver port_number</code> to start the
 * server.
 * <p>
